...
-- Insert player here
insert info players(name ,age , team, games , points) Values('Anderson Varejao', '29' , 'CLE' , '25' , '271');
...
FROM '/Users/muneerabinbaz/code/wdi/homework/hw-w04d04-NBA-SQL/nba_season_2011_2012.csv'
    from ',' CSV;
