...
CREATE TABLE players(name TEXT , age INT , team varchar(5), games INT , points INT);
-- Insert player here
...
FROM '/Users/maymo7a/code/wdi/homework/hw-w04d04-NBA-SQL/nba_season_2011-2012.csv'
    DELIMITER ',' CSV;
